package com.ash.editor.SaveFile;
...
public class SaveFile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setToolTipText("Write a content.");

        textContent.setColumns(20);
        textContent.setRows(5);
        textContent.setToolTipText("Write your thoughts.");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        fs.setFileFilter(new javax.swing.filechooser.FileNameExtensionFilter(".txt", "Text file"));
        int result = fs.showOpenDialog(null);
        if (result == JFileChooser.APPROVE_OPTION) {
            String content = textContent.getText();
            File textFile = fs.getSelectedFile();
            try {
                FileWriter fw = new FileWriter(textFile.getPath());
                 fw.write(content);
                 fw.flush();
                 fw.close();
            } catch (Exception e) {
